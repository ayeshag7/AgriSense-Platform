  ...
  return (
    <div className="flex flex-col gap-8 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white border border-gray-300 rounded-lg pt-6 pb-14 px-6 shadow-sm h-96">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white border border-gray-300 rounded-lg pt-6 pb-20 px-6 shadow-sm h-96">
