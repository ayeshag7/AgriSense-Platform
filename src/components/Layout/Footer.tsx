      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8 lg:px-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="flex items-center">
              <Image src="/images/agrisense-logo.png" alt="Mass Reporting Logo" width={64} height={64} />
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-100 text-sm font-medium">
                ...
                <li>
                  <a href="https://github.com/usmansafdarktk/Mass-Reporting-Web-App" target="_blank" rel="noreferrer" className="hover:underline">
                    Contribute
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="text-gray-100 text-sm font-medium">
                {['Facebook', 'Discord', 'Twitter'].map((name) => (
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            ...
            {/* Twitter */}
            <a href="https://twitter.com/ayesha_g7" target="_blank" rel="noreferrer" className="text-[#64FF64]">
